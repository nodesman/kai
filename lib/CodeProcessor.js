...
import fs from 'fs'; // Import the synchronous fs module (for the existence check)
...
class CodeProcessor {
    constructor(config) {
        ...
        //this.srcDir = path.join(this.projectRoot, 'src'); // No longer needed

        // --- Removed src directory check ---
    }

    // ... (rest of the CodeProcessor.js file remains the same) ...
    countTokens(text) {
    ...
    async buildPreloadPrompt(userPrompt) {
        ...
        // --- Use getProjectFiles instead of getAllFiles ---
